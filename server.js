...
function gateKeeper(req, res, next) {
  ...
  const parsed = queryString.parse(usernamePassword);
  req.user = USERS.find(obj=>obj.userName===parsed.user&&parsed.pass ===obj.password);    //////ONELINER AFTER REVIEWING SOLUTION
// if( USERS.find(obj=> obj.userName === parsed.user && parsed.pass ===obj.password)){
//   req.user = parsed.user
//   console.log("hi",req.user);                                                  ///////////SECOND TRY
// }else{
//   req.user = null;
...
//     if (obj.userName  === parsed.user && parsed.pass === obj.password ){
//        console.log("user", parsed.user);
//       return req.user = parsed.user                                            //////FIRST TRY
//     }else {return req.user = null;}
